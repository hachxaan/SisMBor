...
class MantenimientoListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Catálogos / Mantenimientos'
        context['create_url'] = reverse_lazy('OBTaller:mantenimiento_create')
        context['list_url'] = reverse_lazy('OBTaller:mantenimiento_list')
...
class MantenimientoCreateView(LoginRequiredMixin, ValidatePermissionRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Nuevo Mantenimiento'
        context['entity'] = 'Mantenimiento'
...
class MantenimientoDeleteView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DeleteView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Eliminar Mantenimiento'
        context['entity'] = 'Mantenimiento'
        context['list_url'] = self.success_url
        context['catalogos']='menu-is-opening menu-open'
        context['mantenimiento']='active'
